...
public class PerfectTextView extends AppCompatTextView {
    ...
    public PerfectTextView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        super.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                boolean hasClick = onClickListener != null || onDoubleClickListener != null || onLongClickListener != null || onDrawableStartClickListener != null || onDrawableEndClickListener != null || onDrawableLeftClickListener != null || onDrawableTopClickListener != null || onDrawableRightClickListener != null || onDrawableBottomClickListener != null ||

                        onDrawableStartLongClickListener != null || onDrawableEndLongClickListener != null || onDrawableLeftLongClickListener != null || onDrawableTopLongClickListener != null || onDrawableRightLongClickListener != null || onDrawableBottomLongClickListener != null ||

                        onDrawableStartDoubleClickListener != null || onDrawableEndDoubleClickListener != null || onDrawableLeftDoubleClickListener != null || onDrawableTopDoubleClickListener != null || onDrawableRightDoubleClickListener != null || onDrawableBottomDoubleClickListener != null;
                ...
                if ((movementMethod != null || onCheckIsTextEditor()) && isEnabled() && text instanceof Spannable && getLayout() != null) {
                    ...
                    boolean isInTextScope = event.getX() >= left && event.getX() <= right && event.getY() >= top && event.getY() <= bottom;
    ...
    private void initCompoundDrawables() {
        ...
        if (isRtl) {
            setCompoundDrawablesRelative(drawableStart != null ? drawableStart : drawableRight, drawableTop, drawableEnd != null ? drawableEnd : drawableLeft, drawableBottom);
        } else {
            setCompoundDrawablesRelative(drawableStart != null ? drawableStart : drawableLeft, drawableTop, drawableEnd != null ? drawableEnd : drawableRight, drawableBottom);
        }
    ...
    public void setDrawableStart(Drawable drawableStart) {
        ...
        if (isRtl) {
            setCompoundDrawablesRelative(drawableStart, drawableTop, drawableEnd != null ? drawableEnd : drawableLeft, drawableBottom);
        } else {
            setCompoundDrawablesRelative(drawableStart, drawableTop, drawableEnd != null ? drawableEnd : drawableRight, drawableBottom);
        }
    }
    ...
    public void setDrawableEnd(Drawable drawableEnd) {
        ...
        if (isRtl) {
            setCompoundDrawablesRelative(drawableStart != null ? drawableStart : drawableRight, drawableTop, drawableEnd, drawableBottom);
        } else {
            setCompoundDrawablesRelative(drawableStart != null ? drawableStart : drawableLeft, drawableTop, drawableEnd, drawableBottom);
        }
    }
    ...
    private final GestureDetector gestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            return clickEvent(e, ClickType.DoubleClick);
        }
        ...
        private boolean clickEvent(MotionEvent e, ClickType clickType) {
            ...
            if (!isClick) {
                ...
                int right = getWidth() - getCompoundPaddingRight();
                int bottom = getHeight() - getCompoundPaddingBottom();
                boolean isInTextScope = e.getX() >= left && e.getX() <= right && e.getY() >= top && e.getY() <= bottom;
                if (clickType == ClickType.Click && onClickListener != null && (clickScope == ClickScope.allScope || (clickScope == ClickScope.textScope && isInTextScope))) {
                    returnClick = true;
                    onClickListener.onClick(PerfectTextView.this);
                }
                if (clickType == ClickType.LongClick && onLongClickListener != null && (longClickScope == ClickScope.allScope || (longClickScope == ClickScope.textScope && isInTextScope))) {
                    returnClick = onLongClickListener.onLongClick(PerfectTextView.this);
                }
                if (clickType == ClickType.DoubleClick && onDoubleClickListener != null && (doubleClickScope == ClickScope.allScope || (doubleClickScope == ClickScope.textScope && isInTextScope))) {
                    returnClick = true;
    ...
    private void setPressed(boolean pressed, MotionEvent e) {
        ...
        if (!isClick && onClickListener != null) {
            if (clickScope == ClickScope.allScope || (clickScope == ClickScope.textScope && e.getX() >= left && e.getX() <= right && e.getY() >= top && e.getY() <= bottom)) {
                setPressed(true);
            }
        }
    ...
    private void setSelectText() {
        ...
        if (isSelected()) {
            ...
            if (!TextUtils.isEmpty(selectedHint)) {
    ...
    public void setPressed(boolean pressed) {
        ...
        Drawable drawableRight = drawables[2];
        if (isRtl) {
            if (onDrawableLeftClickListener == null && onDrawableLeftDoubleClickListener == null && onDrawableLeftLongClickListener == null && onDrawableEndClickListener == null && onDrawableEndDoubleClickListener == null && onDrawableEndLongClickListener == null) {
                setPressed(drawableLeft, pressed);
            }
            if (onDrawableRightClickListener == null && onDrawableRightDoubleClickListener == null && onDrawableRightLongClickListener == null && onDrawableStartClickListener == null && onDrawableStartDoubleClickListener == null && onDrawableStartLongClickListener == null) {
                setPressed(drawableRight, pressed);
            }
        } else {
            if (onDrawableLeftClickListener == null && onDrawableLeftDoubleClickListener == null && onDrawableLeftLongClickListener == null && onDrawableStartClickListener == null && onDrawableStartDoubleClickListener == null && onDrawableStartLongClickListener == null) {
                setPressed(drawableLeft, pressed);
            }
            if (onDrawableRightClickListener == null && onDrawableRightDoubleClickListener == null && onDrawableRightLongClickListener == null && onDrawableEndClickListener == null && onDrawableEndDoubleClickListener == null && onDrawableEndLongClickListener == null) {
                setPressed(drawableRight, pressed);
            }
        }
        if (onDrawableTopDoubleClickListener == null && onDrawableTopClickListener == null && onDrawableTopLongClickListener == null) {
            setPressed(drawableTop, pressed);
        }
        if (onDrawableBottomDoubleClickListener == null && onDrawableBottomClickListener == null && onDrawableBottomLongClickListener == null) {
            setPressed(drawableBottom, pressed);
        }
    }
